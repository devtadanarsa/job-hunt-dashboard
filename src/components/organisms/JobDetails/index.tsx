...
const JobDetails: FC<JobDetailsProps> = ({ detail }) => {
      ...
      <div className="grid grid-cols-3 w-full gap-5">
        ...
        <div>
          ...
          <div className="bg-gray-100 p-3 text-center my-6">
            {detail?.applicants}{" "}
            <span className="text-gray-500">of {detail?.needs} capacities</span>
            <Progress
          ...
          <div className="my-10">
            ...
            <div className="space-x-5 space-y-5">
              ...
              {detail?.requiredSkills.map((item: string, i: number) => (
                <Badge key={item + i} className="rounded-none py-2 px-3">
                  {item}
                </Badge>
              ))}
            </div>
          ...
          <div className="my-10">
            ...
            <div className="space-x-5">
              <Badge className="rounded-none py-2 px-3">
